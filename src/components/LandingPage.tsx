...
const PrimaryBtn = ({
  ...
  if (href) {
    return (
      ...
      >
        {children}
        <span className="flex items-center justify-center w-7 h-7 rounded-full bg-white/30"><ArrowRight size={14} strokeWidth={2.5} /></span>
      </a>
    );
  }
...
const SecondaryBtn = ({ children, href }: { children: React.ReactNode; href?: string }) => {
  ...
  return (
    <Tag
      href={href}
      className="group inline-flex items-center gap-2 px-6 py-3 rounded-full font-bold text-slate-800 text-base
        border-2 border-slate-800 bg-transparent transition-all duration-300"
...
const DotGrid = ({ className }: { className?: string }) => (
  <svg className={`absolute pointer-events-none select-none ${className}`} width="200" height="200" aria-hidden>
    <defs>
...
const FloatCircle = ({
  ...
  <div
    ...
    style={{ width: size, height: size, background: color, opacity: 0.18, border: "2px solid #1E293B" }}
  />
);

const FloatTriangle = ({ color, className }: { color: string; className?: string }) => (
  <svg
    aria-hidden
    ...
    viewBox="0 0 40 40"
  >
    <polygon points="20,4 36,36 4,36" fill={color} fillOpacity="0.22" stroke="#1E293B" strokeWidth="1.5" />
  </svg>
);
...
const SectionHeading = ({
  ...
  <div className="text-center mb-16">
    ...
    {sub && (
      <p className="mt-4 text-slate-500 text-lg max-w-2xl mx-auto" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
        {sub}
      </p>
    )}
  </div>
    ...
    >
      <div className="max-w-6xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-extrabold text-slate-800 text-lg" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
...
const Hero = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center overflow-hidden pt-24 pb-16" style={{ background: "#FFFDF5" }}>
      {/* BG shapes */}
      <div
        aria-hidden
        className="absolute -top-20 -left-20 w-125 h-125 rounded-full"
        style={{ background: "#FBBF24", opacity: 0.18, border: "2px solid #1E293B" }}
      />
      <DotGrid className="right-0 top-40 opacity-70" />
      <FloatCircle size={60} color="#F472B6" className="top-32 right-1/4" />
      <FloatTriangle color="#34D399" className="bottom-32 left-1/4" />
      <FloatCircle size={30} color="#8B5CF6" className="bottom-40 right-16" />
      <FloatTriangle color="#F472B6" className="top-48 left-1/3" />
      ...
      <div className="max-w-6xl mx-auto px-6 grid md:grid-cols-2 gap-12 items-center w-full">
        ...
        >
          ...
          >
            ...
            with{" "}
            <span style={{ color: "#F472B6" }}>Learner's AI</span>
          </h1>
          ...
          <p
            ...
            style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}
          >
            An intelligent course recommendation system powered by Explainable Artificial Intelligence that helps students choose the right academic path based on their interests, skills, and goals.
          </p>
          ...
          <div className="flex flex-wrap gap-3 mt-10">
            {[
              ...
              >
                <span className="font-extrabold text-slate-800" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>{n}</span>
                <span className="text-slate-500 text-sm" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>{l}</span>
              </div>
            ))}
          </div>
        </div>
        ...
        >
          <DotGrid className="left-0 top-0 w-full h-full opacity-40" />
          ...
          >
            ...
            <div className="flex items-center gap-3 mb-4">
              <div className="w-10 h-10 rounded-full flex items-center justify-center border-2 border-slate-800" style={{ background: "#8B5CF6" }}>
                <Brain size={18} color="white" strokeWidth={2.5} />
              </div>
              <div>
                <p className="font-bold text-slate-800 text-sm" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>AI Analysis Complete</p>
                <p className="text-xs text-slate-400" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>Based on your profile</p>
              </div>
            ...
            {[
              ...
              <div key={label} className="mb-3">
                <div className="flex justify-between text-xs mb-1">
                  <span className="font-medium text-slate-700" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>{label}</span>
            ...
            >
              ...
              <p className="text-xs font-medium text-slate-600" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
          ...
          <div
            ...
            style={{ boxShadow: "3px 3px 0 #1E293B", transform: "rotate(6deg)" }}
          >
            <span className="text-xs font-bold text-slate-800" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>✨ XAI Powered</span>
          </div>
          <div
            className="absolute -bottom-4 -left-4 z-20 bg-[#F472B6] border-2 border-slate-800 rounded-xl px-3 py-2"
            style={{ boxShadow: "3px 3px 0 #1E293B", transform: "rotate(-5deg)" }}
          >
            <span className="text-xs font-bold text-white" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>🎯 Personalized</span>
          </div>
        </div>
      </div>
      ...
      <div className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 opacity-50">
        <span className="text-xs text-slate-500" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>Scroll to explore</span>
...
/* ─── ABOUT ───────────────────────────────────────────────────── */
const About = () => (
  <section id="about" className="py-24 relative overflow-hidden" style={{ background: "#F1F5F9" }}>
    <FloatCircle size={120} color="#8B5CF6" className="-top-10 -right-10" />
    <FloatTriangle color="#FBBF24" className="bottom-8 left-8" />
...
const WhyChoose = () => (
  <section id="why-us" className="py-24 relative overflow-hidden" style={{ background: "#FFFDF5" }}>
    <FloatCircle size={80} color="#F472B6" className="top-10 right-10" />
    <FloatTriangle color="#8B5CF6" className="bottom-10 left-10" />

    <div className="max-w-6xl mx-auto px-6">
      <SectionHeading
        badge="Why Choose Us"
        title={<>Why Choose <span style={{ color: "#8B5CF6" }}>Learner's AI</span>?</>}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {whyItems.map(({ icon: Icon, title, desc, color, shadow }) => (
          ...
          >
            ...
            <p className="text-slate-500 leading-relaxed" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
              {desc}
            </p>
...
const HowItWorks = () => (
  <section id="how-it-works" className="py-24 relative overflow-hidden" style={{ background: "#1E293B" }}>
    {/* BG decoration */}
    ...
    <div className="max-w-6xl mx-auto px-6 relative z-10">
      ...
      <div className="relative">
        ...
        <div
          ...
          style={{ background: "repeating-linear-gradient(90deg,#8B5CF6 0,#8B5CF6 8px,transparent 8px,transparent 20px)" }}
        />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-6">
          {steps.map(({ n, title, desc, color }) => (
            <div key={n} className="flex flex-col items-center text-center group">
              ...
              >
                <span className="text-3xl font-extrabold text-white" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>{n}</span>
              </div>
              <h3 className="font-bold text-white text-base mb-2" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>{title}</h3>
              <p className="text-slate-400 text-sm leading-relaxed" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>{desc}</p>
            </div>
          ))}
        </div>
      </div>
...
const Features = () => (
  <section id="features" className="py-24 relative overflow-hidden" style={{ background: "#FFFDF5" }}>
    <DotGrid className="left-0 top-0" />
    <FloatCircle size={100} color="#34D399" className="-bottom-10 -right-10" />

    <div className="max-w-6xl mx-auto px-6 relative z-10">
      <SectionHeading
        badge="Key Features"
        title={<>Everything You Need, <span style={{ color: "#F472B6" }}>All in One Place</span></>}
        badgeColor="#34D399"
      />
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {features.map(({ icon: Icon, label, desc, color }) => (
          ...
          >
            ...
            <div>
              <h3 className="font-bold text-slate-800 mb-1" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>{label}</h3>
              <p className="text-slate-500 text-sm leading-relaxed" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>{desc}</p>
            </div>
          </div>
        ))}
      </div>
...
const ForWho = () => (
  <section id="for-who" className="py-24 relative overflow-hidden" style={{ background: "#F1F5F9" }}>
    <FloatTriangle color="#FBBF24" className="top-10 right-20" />
    <FloatCircle size={70} color="#8B5CF6" className="bottom-10 left-10" />

    <div className="max-w-6xl mx-auto px-6">
      <SectionHeading
        badge="Who Is This For?"
        title={<>Built for <span style={{ color: "#34D399" }}>Every Learner</span></>}
        badgeColor="#FBBF24"
      />
...
const Mission = () => (
  <section className="py-24 relative overflow-hidden" style={{ background: "#FFFDF5" }}>
    <div
      ...
      style={{
        background: "radial-gradient(ellipse 60% 60% at 50% 50%, #EDE9FE 0%, transparent 70%)",
      }}
    />
    <FloatCircle size={60} color="#F472B6" className="top-10 left-10" />
    <FloatTriangle color="#34D399" className="bottom-10 right-10" />
    ...
    <div className="max-w-3xl mx-auto px-6 text-center relative z-10">
      ...
      <p
        ...
        style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}
      >
        To empower students with intelligent tools that enhance academic decision-making, improve learning experiences, and align education with future career success.
      </p>
      <div
      ...
      >
        <div className="w-10 h-10 rounded-full flex items-center justify-center border-2 border-slate-800" style={{ background: "#FBBF24" }}>
          <Star size={18} strokeWidth={2.5} color="#1E293B" />
        </div>
        <p className="font-bold text-slate-800" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
...
const CTA = () => {
  const navigate = useNavigate();
  return (
  <section className="py-24 relative overflow-hidden" style={{ background: "#8B5CF6" }}>
    <DotGrid className="left-0 top-0 opacity-20" />
    <DotGrid className="right-0 bottom-0 opacity-20" />
    <FloatCircle size={200} color="#FBBF24" className="-top-20 -right-20" />
    <FloatCircle size={150} color="#F472B6" className="-bottom-20 -left-20" />
  ...
  <footer className="py-10 border-t-2 border-slate-200" style={{ background: "#FFFDF5" }}>
    <div className="max-w-6xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-4">
      <div className="flex items-center gap-2">
        ...
        <span className="font-extrabold text-slate-800" style={{ fontFamily: "'Outfit', system-ui, sans-serif" }}>
          Learner's <span style={{ color: "#8B5CF6" }}>AI</span>
        </span>
      </div>
      <p className="text-slate-400 text-sm" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
        © {new Date().getFullYear()} Learner's AI. Empowering students with intelligent tools.
      </p>
      <div className="flex gap-4">
        {["Privacy", "Terms", "Contact"].map((l) => (
          <a key={l} href="#" className="text-sm text-slate-500 hover:text-violet-600 transition-colors" style={{ fontFamily: "'Plus Jakarta Sans', system-ui, sans-serif" }}>
            {l}
          </a>
        ))}
      </div>
