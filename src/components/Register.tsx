  ...
  return (
    <AuthLayout title="Register" subtitle="Sign up to start learning new skills">
      <form onSubmit={handleRegister} className="space-y-5">
        ...
        {/* EMAIL */}
        <div>
          <label className="block text-xs font-bold uppercase tracking-wide text-[#1E293B] mb-2">
            Email
          </label>
        ...
        <div>
          ...
          <p className="mt-2 text-xs text-[#64748B]">At least 8 characters.</p>
        </div>
